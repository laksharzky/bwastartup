...
func (h *campaignHandler) CreateCampaign(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.APIResponse("Failed to create campaign", http.StatusUnprocessableEntity, "error", errorMsg)
...
func (h *campaignHandler) UpdateCampaign(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.APIResponse("Failed to update campaign", http.StatusUnprocessableEntity, "error", errorMsg)
		c.JSON(http.StatusUnprocessableEntity, response)
		return
	}
...
func (h *campaignHandler) UploadImage(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.APIResponse("Failed to upload campaign image", http.StatusUnprocessableEntity, "error", errorMsg)
		c.JSON(http.StatusUnprocessableEntity, response)
		return
	}
	...
	response := helper.APIResponse("Successfully uploaded image", http.StatusOK, "success", data)
	c.JSON(http.StatusOK, response)
